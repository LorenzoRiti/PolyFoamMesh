...
class FullAutoPipeline:
    ...
    def _step_import_heal(self, geometry_path: str):
        ...
        from polyfoammesh.commercial.geometry_pipeline import GeometryPipeline
        gp = GeometryPipeline()
    ...
    def _step_quality_fix(self, case_dir: str):
        ...
        from polyfoammesh.commercial.quality_engine import QualityEngine
        qe = QualityEngine()
    ...
    def _step_solver(self, case_dir: str, template_name: str, bbox_dim: float = 0.0):
        ...
        """
        from polyfoammesh.commercial.template_engine import TemplateEngine
        te = TemplateEngine()
...
def main_cli() -> None:
    ...
    Usage::
        ...
        python -m polyfoammesh.commercial.one_click_run model.step \\
