...
from polyfoammesh.core.validation import validate_cell_size, validate_geometry_path
...
class FaultTolerantWorkflow:
    ...
    def _step_import(self) -> None:
        ...
        if ext in (".step", ".stp"):
            from polyfoammesh.core.geometry import load_step, classify_faces, tessellate_patches
