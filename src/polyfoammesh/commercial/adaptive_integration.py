...
class OODAWorkflowAdapter:
    ...
    def run(
        ...
        from polyfoammesh.commercial.mesh_engine import MeshEngine, MeshEngineParams
    ...
    def run_parallel(
        ...
        from polyfoammesh.commercial.quality_engine import QualityEngine
        from polyfoammesh.commercial.parallel_mesh import ParallelMeshEngine, DecomposeParams
