...
from polyfoammesh.core.case_setup import write_control_dict as _write_control_dict
from polyfoammesh.core.quality_thresholds import ADAPTIVE_THRESHOLDS
from polyfoammesh.core.validation import validate_case_dir
...
class MeshEngine:
    ...
    def _run_parallel_mesh(
        ...
        from polyfoammesh.commercial.parallel_mesh import ParallelMeshEngine
    ...
    def _run_tetrahedral(self, case_dir: Path, geometry_path: str) -> None:
        ...
        from polyfoammesh.core.gmsh_wrapper import generate_volume_mesh
        from polyfoammesh.core.mesh_converter import msh_to_of_polymesh
    ...
    def _run_snappy_hex_mesh(
        ...
        from polyfoammesh.commercial.snappy_hex_mesh import SnappyHexMeshRunner
    ...
    def _run_mmg_adaptation(self, case_dir: Path) -> None:
        ...
        from polyfoammesh.commercial.mmg_adaptation import MmgAdaptationRunner
...
def _validate_sizes(bbox_dim: float, max_cell: float, min_cell: float) -> tuple[float, float, list[str]]:
    from polyfoammesh.core.validation import validate_cell_size as _vc
