...
def _read_points(path: Path) -> np.ndarray:
    ...
    from polyfoammesh.core.of_reader import read_of_text
...
def _read_owner_neighbour(path: Path) -> np.ndarray:
    ...
    """
    from polyfoammesh.core.of_reader import _is_binary_format, read_of_text
    if _is_binary_format(path):
        from polyfoammesh.core.of_reader import of_label_list
...
def main(argv: list[str] | None = None) -> int:
    ...
    Usage::
        ...
        python -m polyfoammesh.commercial.poly_aggregator \\
