...
def build_graded_refinement_boxes(
    ...
    try:
        ...
        from polyfoammesh.core.gmsh_wrapper import _relax_size_field_growth_rate
...
def cfmesh_cell_budget(
    ...
    """
    from polyfoammesh.core.hardware_budget import (
...
def coarsen_for_ram_budget(
    ...
    if est_cells <= budget["max_cells"]:
        return max_cell, warnings
    from polyfoammesh.core.hardware_budget import available_ram_bytes, fmt_bytes
